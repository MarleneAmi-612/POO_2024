...
class Coches:
    ...
    def getInfo(self):
        print(f"Marca: {self.getMarca()} {self.getColor()}, número de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de {self.getVelocidad()} Km/h y una potencia de {self.getCaballaje()} hp")
...
class Camiones(Coches):
    ...
    def getInfo(self):
        super().getInfo()
        print(f"Eje: {self.getEje()}, Capacidad de carga: {self.getCapacidadCarga()} metros cúbicos")
...
class Camionetas(Coches):
    ...
    def getInfo(self):
        super().getInfo()
        print(f"Tracción: {self.getTraccion()}, Cerrada: {'Sí' if self.getCerrada() else 'No'}")
